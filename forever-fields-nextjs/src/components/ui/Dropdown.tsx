...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-sage-pale bg-white p-1 shadow-soft",
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-sage-pale focus:text-sage-dark",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-2 text-xs font-semibold text-gray-body uppercase tracking-wider",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-sage-pale", className)}
    {...props}
  />
));
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto text-xs tracking-widest text-gray-body", className)}
      {...props}
    />
  );
};
